...
var LRUStorage = /** @class */ (function () {
    ...
    LRUStorage.prototype.getItem = function (key) {
    ...
    LRUStorage.prototype.setItem = function (key, content) {
        return __awaiter(this, void 0, void 0, function () {
            var cache;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LRUStorage.prototype.clear = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        c1 = new lru_1.LRUCache();
                        return [4 /*yield*/, this.makeEmptyCache(c1)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, fs_p.readFile(this.filePath)];
    ...
    LRUStorage.prototype.setCache = function (updatedCache) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_p.writeFile(this.filePath, JSON.stringify(updatedCache)).catch(function (err) { console.error(err); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
